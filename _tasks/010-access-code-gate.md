...
- [ ] `GET /rsvp` (unauthenticated) renders the entry form; (authenticated) renders a placeholder "RSVP form goes here" — the real form is task 011
- [ ] `_tasks/010-access-code-gate.md` deleted in the merging PR
