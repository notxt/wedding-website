...
- [ ] Favicon route (use a generic placeholder — task 012 designer can swap later)
...
- [ ] `_tasks/013-error-pages-and-polish.md` deleted in the merging PR

## Notes
- This is the "looks-good locally" gate before task 014 begins AWS work.
