# 003 — Layout template and home page
...
- [ ] `_tasks/003-layout-template-and-home.md` deleted in the merging PR

## Notes
- Keep the home page minimal — task 012 (styling pass) is where the invite SVG hero gets its real treatment. For now, a heading + names + date is fine.
